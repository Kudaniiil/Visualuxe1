...
<script>
	alert_toast("<?php echo $_settings->flashdata('Berhasil') ?>",'success')
</script>
<?php endif;?>
<div class="w-100 d-flex justify-content-between border-bottom py-2">
	<h3>Album</h3>
	<button class="btn btn-icon-split btn-danger" type="button" id="permanently_delete"><i class="fa fa-trash-alt"></i> Hapus Permanen</button>
</div>
			...
			<div class="w-100 d-flex justify-content-between">
				...
				<div  class="dropleft">
					...
					<div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
						<a class="dropdown-item retrieve_album" data-id="<?php echo $row['id'] ?>" href="javascript:void(0)"><i class="fa fa-undo-alt text-dark"></i> Pulihkan Album</a>
					</div>
				</div>
			</div>
		</a>
...
<div class="row">
    <div class="w-100 p-2 text-center" id="nData" style="display:none"><b>Tidak Ada Album</b></div>
</div>
<div class="w-100 d-flex justify-content-between border-bottom py-2">
	<h3>Foto</h3>
</div>
		...
		<a href="javascript:void(0)" data-id="<?php echo $row['id'] ?>" class="img-item">
			...
			<div class="w-100 d-flex justify-content-between">
				...
				<div  class="dropleft">
					<a href="#" id="menus_<?php echo $row['id'] ?>" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="text-dark"><i class="fa fa-ellipsis-v"></i> </a>
					<div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        <a class="dropdown-item retrieve_image" data-id="<?php echo $row['id'] ?>" data-album-id="<?php echo $row['album_id'] ?>" href="javascript:void(0)"><i class="fa fa-undo-alt text-dark"></i> Pulihkan Gambar</a>
					</div>
				</div>
			</div>
		</a>
...
<div class="row">
    <div class="w-100 p-2 text-center" id="nData2" style="display:none"><b>Tidak Ada Foto</b></div>
</div>
<script>
	$(document).ready(function(){
		...
		$('.retrieve_album').click(function(){
			_conf("Apakah Anda yakin untuk memulihkan Album ini ?","retrieve_album",[$(this).attr('data-id')])
		})
        $('.retrieve_image').click(function(){
			_conf("Apakah Anda yakin untuk memulihkan Gambar ini ?","retrieve_image",[$(this).attr('data-id'),$(this).attr('data-album-id')])
		})
        $('#permanently_delete').click(function(){
			_conf("Apakah Anda yakin untuk mengosongkan arsip ?","permanently_delete",[])
		})
	})
