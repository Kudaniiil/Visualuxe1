...
<div class="w-100 d-flex justify-content-between border-bottom py-2">
	<h3>Album</h3>
	<button class="btn  btn-success btn-icon-split" type="button" id="add-new"><i class="fa fa-plus"></i> Tambah Baru</button>
</div>
			...
			<div class="w-100 d-flex justify-content-between">
				...
				<div  class="dropleft">
					...
					<div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
						<a class="dropdown-item edit_album" data-id="<?php echo $row['id'] ?>" href="javascript:void(0)"><i class="fa fa-edit text-primary"></i> Ganti Nama</a>
						<div class="dropdown-divider"></div>
						<a class="dropdown-item delete_album" data-id="<?php echo $row['id'] ?>" href="javascript:void(0)"><i class="fa fa-trash text-danger"></i> Hapus</a>
					</div>
				</div>
			</div>
		</a>
...
<script>
	$(document).ready(function(){
		...
		$('#add-new').click(function(){
			uni_modal("<i class='fa fa-plus text-success'></i> Buat Album Baru", "albums/manage_album.php")
		})
		$('.edit_album').click(function(){
			uni_modal("<i class='fa fa-edit text-primary'></i> Ubah Nama Album", "albums/manage_album.php?id="
		+$(this).attr('data-id'))
		})
		$('.delete_album').click(function(){
			_conf("Apakah Anda yakin akan menghapus Album ini ?","delete_album",[$(this).attr('data-id')])
		})
